...
:- discontigous(a_character/0).
:- discontigous(a_level/0).
:- discontigous(a_health/0).
:- discontigous(a_attack/0).
:- discontigous(a_defense/0).
:- discontigous(a_exp/0).
:- discontigous(a_gold/0).
